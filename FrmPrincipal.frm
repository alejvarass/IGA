...
Public Sub SaveLayout()
    ...
    For Each ctrl In Me.Controls
        ...
        ' Si es un SSTab, además guardamos los controles que contiene en cada Tab
        If InStr(LCase(TypeName(ctrl)), "sstab") > 0 Or InStr(LCase(TypeName(ctrl)), "tab") > 0 Then
            Set sst = ctrl
            On Error Resume Next
            ' TabCount / Tabs property: intentamos iterar por índice
...
Private Sub MDIForm_Load()
    ...
    ' Mostrar el formulario hijo antes de ajustar tamaños
    FrmAnalisis.Show
    DoEvents

    ' Intentamos configurar MDI y child al tamaño de pantalla de forma robusta
    On Error Resume Next
    MakeMDIFullScreen
    DoEvents
    ...
    ' dejamos aquí cualquier otra inicialización necesaria.

...
Private Sub MDIForm_Load()
    ...
    ' Mostrar el formulario hijo antes de ajustar tama�os
    FrmAnalisis.Show
    DoEvents

    ' Intentamos configurar MDI y child al tama�o de pantalla de forma robusta
    On Error Resume Next
    MakeMDIFullScreen
    DoEvents

    ' Escalado del MDI principal (si tiene controles propios)
    On Error Resume Next
    ScaleLayout

    ' Nota: MakeMDIFullScreen ya llama a ResizeChildToClient / ApplyAnchors/ScaleLayout para FrmAnalisis
    ' dejamos aqu� cualquier otra inicializaci�n necesaria.

    On Error GoTo ErrHandler

    Exit Sub
ErrHandler:
    MsgBox "Error en MDIForm_Load: " & Err.Number & " - " & Err.Description, vbExclamation, "Error"
    Err.Clear
End Sub
...
Private Sub InicializarClienteBaselineGasTotal()
    ...
    ' la direcci�n IP (como "121.111.1.1") o
    ' el nombre "descriptivo" del equipo, como se muestra aqu�.
    tcpClient.Close
...
' Invoca el m�todo Connect para iniciar
' una conexi�n.
On Error GoTo Error
...
Private Sub MDIForm_Resize()
   On Error Resume Next
    ' Mantener el MDI a pantalla completa y redimensionar el child de forma centralizada
    OnMDIResized
End Sub
...
Sub SetearMenuZonaMuerta(ByVal Indice As Long)
    ...
    If FrmAnalisis.ChkTiempoReal = 1 Then
        ...
        FrmAnalisis.iPlotGases.XAxis(0).Span = ObtenerSpanEnD�as(FechaInicio, DateAdd("n", gZonaMuerta, FechaFin))
        FrmAnalisis.iPlotGases.EndUpdate
    ...
    If Not rs Is Nothing Then
        If Not rs.EOF Then
            ...
            If gMetroCortadoActual > Desde Then
                'Debo actualizar la colecci�n de escaneos
            ...
            ElseIf gMetroCortadoActual < gObjPozoActivo.PozoEscaneos.colMaxProfPozoEscaneo Then
                'Levantaron la profundidad de pozo en dc_dt, hay que consultar de nuevo la colecci�n de metros cortados

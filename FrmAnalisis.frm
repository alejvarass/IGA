    ...
    For Each ctrl In Me.Controls
        ...
        If InStr(LCase(TypeName(ctrl)), "sstab") > 0 Or InStr(LCase(TypeName(ctrl)), "tab") > 0 Then
            ...
            For t = 0 To sst.Tabs - 1
                ' ControlCount para cada pestaña
                For i = 0 To sst.Tab(t).ControlCount - 1
                    ...
                    If Not tCtrl Is Nothing Then
                        ...
                        ' Usamos ParentName para localizarlo después
                        mask = "L" ' por defecto anclado a la izquierda; ApplyAnchors tratará estiramientos dependiendo del ancho/alto original
...
Public Sub ApplyAnchors()
    ...
    ' Primero redimensionar/colocar los controles directos del formulario (incluyendo el SSTab en sí)
    For Each ctrl In Me.Controls
    ...
    ' Ahora ajustar los controles que habíamos guardado como ORIGTAB (controles dentro de SSTab)
    For Each ctrl In Me.Controls
        If InStr(LCase(TypeName(ctrl)), "sstab") > 0 Or InStr(LCase(TypeName(ctrl)), "tab") > 0 Then
            Set sst = ctrl
            On Error Resume Next
                    ...
                    If Not tCtrl Is Nothing Then
                        If Len(tCtrl.Tag) > 7 And Left$(tCtrl.Tag, 7) = "ORIGTAB" Then
                            ...
                            If UBound(arr) >= 9 Then
                                ...
                                mask = arr(10)
                                If Left$(mask, 2) = "A=" Then mask = Mid$(mask, 3)
                                ' Volver a calcular posición absoluta nueva según el tamaño del form:
